 ...
 *   -- Tests the distances achieved by the robot (Lego):re
 ...
 *
 *   3. Get the SPEEDS right by using the     test_lego_speeds    file.
 *
 ...
 *         into the     library_lego.c     file at an appropriate place.
...
int main() 
{
	...
	test_robot_forward_backward();
	test_robot_left_right();
...
void test_modest_forward_backward()
{
	...
	test_robot(5, 50, FORWARD);
	test_robot(5, 20, BACKWARD);
}

void test_modest_left_right()
{
	test_robot(10, 90, LEFT);
	test_robot(10, 90, RIGHT);
